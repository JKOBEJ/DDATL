 ...
 * <ul>
 *   <li>{@link VariableExp#getReferredVariable <em>Referred Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @see OCLPackage#getVariableExp()
 * @model
 * @generated
 */
public interface VariableExp extends OclExpression {
	 ...
	 * It is bidirectional and its opposite is '{@link VariableDeclaration#getVariableExp <em>Variable Exp</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see OCLPackage#getVariableExp_ReferredVariable()
	...
	/**
	 * Sets the value of the '{@link VariableExp#getReferredVariable <em>Referred Variable</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
