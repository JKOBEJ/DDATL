 ...
 * <ul>
 *   <li>{@link LoopExpImpl#getBody <em>Body</em>}</li>
 *   <li>{@link LoopExpImpl#getIterators <em>Iterators</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LoopExpImpl extends PropertyCallExpImpl implements LoopExp {
	...
	public EList getIterators() {
		if (iterators == null) {
			iterators = new EObjectContainmentWithInverseEList(Iterator.class, this, OCLPackage.LOOP_EXP__ITERATORS, OCLPackage.ITERATOR__LOOP_EXPR);
		}
		return iterators;
	}
