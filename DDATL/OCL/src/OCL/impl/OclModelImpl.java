 ...
 * <ul>
 *   <li>{@link OclModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link OclModelImpl#getMetamodel <em>Metamodel</em>}</li>
 *   <li>{@link OclModelImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link OclModelImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OclModelImpl extends LocatedElementImpl implements OclModel {
	...
	public EList getElements() {
		if (elements == null) {
			elements = new EObjectWithInverseResolvingEList(OclModelElement.class, this, OCLPackage.OCL_MODEL__ELEMENTS, OCLPackage.OCL_MODEL_ELEMENT__MODEL);
		}
		return elements;
	}
	...
	public EList getModel() {
		if (model == null) {
			model = new EObjectWithInverseResolvingEList(OclModel.class, this, OCLPackage.OCL_MODEL__MODEL, OCLPackage.OCL_MODEL__METAMODEL);
		}
		return model;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case OCLPackage.OCL_MODEL__MODEL:
				return ((InternalEList)getModel()).basicAdd(otherEnd, msgs);
		}
