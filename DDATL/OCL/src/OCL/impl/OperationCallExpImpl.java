 ...
 * <ul>
 *   <li>{@link OperationCallExpImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link OperationCallExpImpl#getOperationName <em>Operation Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationCallExpImpl extends PropertyCallExpImpl implements OperationCallExp {
	...
	public EList getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentWithInverseEList(OclExpression.class, this, OCLPackage.OPERATION_CALL_EXP__ARGUMENTS, OCLPackage.OCL_EXPRESSION__PARENT_OPERATION);
		}
		return arguments;
	}
