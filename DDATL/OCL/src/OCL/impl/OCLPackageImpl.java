...
import OCL.Primitive;
import OCL.PrimitiveExp;
...
public class OCLPackageImpl extends EPackageImpl implements OCLPackage {
	...
	public static OCLPackage init() {
		if (isInited) return (OCLPackage) Registry.INSTANCE.getEPackage(OCLPackage.eNS_URI);

		// Obtain or create and register package
		OCLPackageImpl theOCLPackage = (OCLPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof OCLPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new OCLPackageImpl());

		isInited = true;

		// Obtain or create and register interdependencies
		ATLPackageImpl theATLPackage = (ATLPackageImpl)(Registry.INSTANCE.getEPackage(ATLPackage.eNS_URI) instanceof ATLPackageImpl ? Registry.INSTANCE.getEPackage(ATLPackage.eNS_URI) : ATLPackage.eINSTANCE);
		PrimitiveTypesPackageImpl thePrimitiveTypesPackage = (PrimitiveTypesPackageImpl)(Registry.INSTANCE.getEPackage(PrimitiveTypesPackage.eNS_URI) instanceof PrimitiveTypesPackageImpl ? Registry.INSTANCE.getEPackage(PrimitiveTypesPackage.eNS_URI) : PrimitiveTypesPackage.eINSTANCE);
		...
		Registry.INSTANCE.put(OCLPackage.eNS_URI, theOCLPackage);
	...
	public void initializePackageContents() {
		...
		ATLPackage theATLPackage = (ATLPackage) Registry.INSTANCE.getEPackage(ATLPackage.eNS_URI);
		PrimitiveTypesPackage thePrimitiveTypesPackage = (PrimitiveTypesPackage) Registry.INSTANCE.getEPackage(PrimitiveTypesPackage.eNS_URI);
