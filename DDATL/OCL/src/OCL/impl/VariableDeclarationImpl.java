 ...
 * <ul>
 *   <li>{@link VariableDeclarationImpl#getId <em>Id</em>}</li>
 *   <li>{@link VariableDeclarationImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link VariableDeclarationImpl#getType <em>Type</em>}</li>
 *   <li>{@link VariableDeclarationImpl#getInitExpression <em>Init Expression</em>}</li>
 *   <li>{@link VariableDeclarationImpl#getLetExp <em>Let Exp</em>}</li>
 *   <li>{@link VariableDeclarationImpl#getBaseExp <em>Base Exp</em>}</li>
 *   <li>{@link VariableDeclarationImpl#getVariableExp <em>Variable Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
