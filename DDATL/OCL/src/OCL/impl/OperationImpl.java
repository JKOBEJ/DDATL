 ...
 * <ul>
 *   <li>{@link OperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link OperationImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link OperationImpl#getReturnType <em>Return Type</em>}</li>
 *   <li>{@link OperationImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationImpl extends OclFeatureImpl implements Operation {
	...
	public EList getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentWithInverseEList(Parameter.class, this, OCLPackage.OPERATION__PARAMETERS, OCLPackage.PARAMETER__OPERATION);
		}
		return parameters;
	}
