 ...
 * <ul>
 *   <li>{@link OclTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link OclTypeImpl#getDefinitions <em>Definitions</em>}</li>
 *   <li>{@link OclTypeImpl#getOclExpression <em>Ocl Expression</em>}</li>
 *   <li>{@link OclTypeImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link OclTypeImpl#getMapType2 <em>Map Type2</em>}</li>
 *   <li>{@link OclTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link OclTypeImpl#getMapType <em>Map Type</em>}</li>
 *   <li>{@link OclTypeImpl#getCollectionTypes <em>Collection Types</em>}</li>
 *   <li>{@link OclTypeImpl#getTupleTypeAttribute <em>Tuple Type Attribute</em>}</li>
 *   <li>{@link OclTypeImpl#getVariableDeclaration <em>Variable Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
