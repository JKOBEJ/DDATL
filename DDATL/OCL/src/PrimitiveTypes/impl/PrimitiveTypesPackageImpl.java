...
public class PrimitiveTypesPackageImpl extends EPackageImpl implements PrimitiveTypesPackage {
	 ...
	 * <!-- end-user-doc -->
	 * @see Registry
	 * @see PrimitiveTypesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static PrimitiveTypesPackage init() {
		if (isInited) return (PrimitiveTypesPackage) Registry.INSTANCE.getEPackage(PrimitiveTypesPackage.eNS_URI);

		// Obtain or create and register package
		PrimitiveTypesPackageImpl thePrimitiveTypesPackage = (PrimitiveTypesPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof PrimitiveTypesPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new PrimitiveTypesPackageImpl());
		...
		Registry.INSTANCE.put(PrimitiveTypesPackage.eNS_URI, thePrimitiveTypesPackage);
