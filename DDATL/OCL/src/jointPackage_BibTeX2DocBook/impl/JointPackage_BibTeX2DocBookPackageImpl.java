...
public class JointPackage_BibTeX2DocBookPackageImpl extends EPackageImpl implements JointPackage_BibTeX2DocBookPackage {
	 ...
	 * <!-- end-user-doc -->
	 * @see Registry
	 * @see JointPackage_BibTeX2DocBookPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static JointPackage_BibTeX2DocBookPackage init() {
		if (isInited) return (JointPackage_BibTeX2DocBookPackage) Registry.INSTANCE.getEPackage(JointPackage_BibTeX2DocBookPackage.eNS_URI);

		// Obtain or create and register package
		JointPackage_BibTeX2DocBookPackageImpl theJointPackage_BibTeX2DocBookPackage = (JointPackage_BibTeX2DocBookPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof JointPackage_BibTeX2DocBookPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new JointPackage_BibTeX2DocBookPackageImpl());
		...
		Registry.INSTANCE.put(JointPackage_BibTeX2DocBookPackage.eNS_URI, theJointPackage_BibTeX2DocBookPackage);
