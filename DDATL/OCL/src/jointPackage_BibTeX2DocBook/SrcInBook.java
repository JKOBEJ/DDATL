 ...
 * </p>
 * <ul>
 *   <li>{@link SrcInBook#getChapter <em>Chapter</em>}</li>
 * </ul>
 *
 * @see JointPackage_BibTeX2DocBookPackage#getSrcInBook()
 * @model
 * @generated
 */
public interface SrcInBook extends SrcBook {
	 ...
	 * @see #setChapter(int)
	 * @see JointPackage_BibTeX2DocBookPackage#getSrcInBook_Chapter()
	...
	/**
	 * Sets the value of the '{@link SrcInBook#getChapter <em>Chapter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
