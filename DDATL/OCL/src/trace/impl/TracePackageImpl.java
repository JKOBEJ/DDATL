...
public class TracePackageImpl extends EPackageImpl implements TracePackage {
	...
	public static TracePackage init() {
		if (isInited) return (TracePackage) Registry.INSTANCE.getEPackage(TracePackage.eNS_URI);

		// Obtain or create and register package
		TracePackageImpl theTracePackage = (TracePackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof TracePackageImpl ? Registry.INSTANCE.get(eNS_URI) : new TracePackageImpl());
		...
		Registry.INSTANCE.put(TracePackage.eNS_URI, theTracePackage);
