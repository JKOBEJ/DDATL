...
public class JointPackage_UML2ERPackageImpl extends EPackageImpl implements JointPackage_UML2ERPackage {
	 ...
	 * <!-- end-user-doc -->
	 * @see Registry
	 * @see JointPackage_UML2ERPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static JointPackage_UML2ERPackage init() {
		if (isInited) return (JointPackage_UML2ERPackage) Registry.INSTANCE.getEPackage(JointPackage_UML2ERPackage.eNS_URI);

		// Obtain or create and register package
		JointPackage_UML2ERPackageImpl theJointPackage_UML2ERPackage = (JointPackage_UML2ERPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof JointPackage_UML2ERPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new JointPackage_UML2ERPackageImpl());
		...
		Registry.INSTANCE.put(JointPackage_UML2ERPackage.eNS_URI, theJointPackage_UML2ERPackage);
