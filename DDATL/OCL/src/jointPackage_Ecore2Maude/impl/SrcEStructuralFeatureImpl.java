 ...
 * </p>
 * <ul>
 *   <li>{@link SrcEStructuralFeatureImpl#isChangeable <em>Changeable</em>}</li>
 *   <li>{@link SrcEStructuralFeatureImpl#isVolatile <em>Volatile</em>}</li>
 *   <li>{@link SrcEStructuralFeatureImpl#isTransient <em>Transient</em>}</li>
 *   <li>{@link SrcEStructuralFeatureImpl#getDefaultValueLiteral <em>Default Value Literal</em>}</li>
 *   <li>{@link SrcEStructuralFeatureImpl#isUnsettable <em>Unsettable</em>}</li>
 *   <li>{@link SrcEStructuralFeatureImpl#isDerived <em>Derived</em>}</li>
 *   <li>{@link SrcEStructuralFeatureImpl#getEContainingClass <em>EContaining Class</em>}</li>
 * </ul>
 *
 * @generated
 */
