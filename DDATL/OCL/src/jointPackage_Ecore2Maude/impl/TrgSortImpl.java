 ...
 * </p>
 * <ul>
 *   <li>{@link TrgSortImpl#getModule <em>Module</em>}</li>
 *   <li>{@link TrgSortImpl#getTheory <em>Theory</em>}</li>
 *   <li>{@link TrgSortImpl#getSubsortRels <em>Subsort Rels</em>}</li>
 *   <li>{@link TrgSortImpl#getSupersortRels <em>Supersort Rels</em>}</li>
 *   <li>{@link TrgSortImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
