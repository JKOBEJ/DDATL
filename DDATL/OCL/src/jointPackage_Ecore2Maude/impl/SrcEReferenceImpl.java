 ...
 * </p>
 * <ul>
 *   <li>{@link SrcEReferenceImpl#isContainment <em>Containment</em>}</li>
 *   <li>{@link SrcEReferenceImpl#isContainer <em>Container</em>}</li>
 *   <li>{@link SrcEReferenceImpl#isResolveProxies <em>Resolve Proxies</em>}</li>
 *   <li>{@link SrcEReferenceImpl#getEOpposite <em>EOpposite</em>}</li>
 *   <li>{@link SrcEReferenceImpl#getEReferenceType <em>EReference Type</em>}</li>
 *   <li>{@link SrcEReferenceImpl#getEKeys <em>EKeys</em>}</li>
 * </ul>
 *
 * @generated
 */
