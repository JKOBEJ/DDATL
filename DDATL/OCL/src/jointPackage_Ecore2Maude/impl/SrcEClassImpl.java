 ...
 * </p>
 * <ul>
 *   <li>{@link SrcEClassImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link SrcEClassImpl#isInterface <em>Interface</em>}</li>
 *   <li>{@link SrcEClassImpl#getESuperTypes <em>ESuper Types</em>}</li>
 *   <li>{@link SrcEClassImpl#getEOperations <em>EOperations</em>}</li>
 *   <li>{@link SrcEClassImpl#getEAllAttributes <em>EAll Attributes</em>}</li>
 *   <li>{@link SrcEClassImpl#getEAllReferences <em>EAll References</em>}</li>
 *   <li>{@link SrcEClassImpl#getEReferences <em>EReferences</em>}</li>
 *   <li>{@link SrcEClassImpl#getEAttributes <em>EAttributes</em>}</li>
 *   <li>{@link SrcEClassImpl#getEAllContainments <em>EAll Containments</em>}</li>
 *   <li>{@link SrcEClassImpl#getEAllOperations <em>EAll Operations</em>}</li>
 *   <li>{@link SrcEClassImpl#getEAllStructuralFeatures <em>EAll Structural Features</em>}</li>
 *   <li>{@link SrcEClassImpl#getEAllSuperTypes <em>EAll Super Types</em>}</li>
 *   <li>{@link SrcEClassImpl#getEIDAttribute <em>EID Attribute</em>}</li>
 *   <li>{@link SrcEClassImpl#getEStructuralFeatures <em>EStructural Features</em>}</li>
 * </ul>
 *
 * @generated
 */
