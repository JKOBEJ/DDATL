...
public class JointPackage_Ecore2MaudePackageImpl extends EPackageImpl implements JointPackage_Ecore2MaudePackage {
	 ...
	 * <!-- end-user-doc -->
	 * @see Registry
	 * @see JointPackage_Ecore2MaudePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static JointPackage_Ecore2MaudePackage init() {
		if (isInited) return (JointPackage_Ecore2MaudePackage) Registry.INSTANCE.getEPackage(JointPackage_Ecore2MaudePackage.eNS_URI);

		// Obtain or create and register package
		JointPackage_Ecore2MaudePackageImpl theJointPackage_Ecore2MaudePackage = (JointPackage_Ecore2MaudePackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof JointPackage_Ecore2MaudePackageImpl ? Registry.INSTANCE.get(eNS_URI) : new JointPackage_Ecore2MaudePackageImpl());
		...
		Registry.INSTANCE.put(JointPackage_Ecore2MaudePackage.eNS_URI, theJointPackage_Ecore2MaudePackage);
