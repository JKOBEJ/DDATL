 ...
 * </p>
 * <ul>
 *   <li>{@link SrcETypedElementImpl#isOrdered <em>Ordered</em>}</li>
 *   <li>{@link SrcETypedElementImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link SrcETypedElementImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link SrcETypedElementImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link SrcETypedElementImpl#isMany <em>Many</em>}</li>
 *   <li>{@link SrcETypedElementImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link SrcETypedElementImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
