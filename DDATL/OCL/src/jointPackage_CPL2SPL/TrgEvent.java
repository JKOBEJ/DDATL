 ...
 * </p>
 * <ul>
 *   <li>{@link TrgEvent#getEventId <em>Event Id</em>}</li>
 *   <li>{@link TrgEvent#getDeclarations <em>Declarations</em>}</li>
 *   <li>{@link TrgEvent#getMethods <em>Methods</em>}</li>
 * </ul>
 *
 * @see JointPackage_CPL2SPLPackage#getTrgEvent()
 * @model
 * @generated
 */
public interface TrgEvent extends TrgSession {
	 ...
	 * @see JointPackage_CPL2SPLPackage#getTrgEvent_EventId()
	...
	/**
	 * Sets the value of the '{@link TrgEvent#getEventId <em>Event Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see JointPackage_CPL2SPLPackage#getTrgEvent_Declarations()
	 ...
	 * @see JointPackage_CPL2SPLPackage#getTrgEvent_Methods()
