 ...
 * </p>
 * <ul>
 *   <li>{@link SrcProxyImpl#getTimeout <em>Timeout</em>}</li>
 *   <li>{@link SrcProxyImpl#getRecurse <em>Recurse</em>}</li>
 *   <li>{@link SrcProxyImpl#getOrdering <em>Ordering</em>}</li>
 *   <li>{@link SrcProxyImpl#getBusy <em>Busy</em>}</li>
 *   <li>{@link SrcProxyImpl#getNoAnswer <em>No Answer</em>}</li>
 *   <li>{@link SrcProxyImpl#getRedirection <em>Redirection</em>}</li>
 *   <li>{@link SrcProxyImpl#getFailure <em>Failure</em>}</li>
 *   <li>{@link SrcProxyImpl#getDefault <em>Default</em>}</li>
 * </ul>
 *
 * @generated
 */
