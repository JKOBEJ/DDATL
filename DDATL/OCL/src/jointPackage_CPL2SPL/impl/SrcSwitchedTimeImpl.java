 ...
 * </p>
 * <ul>
 *   <li>{@link SrcSwitchedTimeImpl#getDtstart <em>Dtstart</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getDtend <em>Dtend</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getFreq <em>Freq</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getUntil <em>Until</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getCount <em>Count</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getInterval <em>Interval</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getBySecond <em>By Second</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getByMinute <em>By Minute</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getByHour <em>By Hour</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getByDay <em>By Day</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getByMonthDay <em>By Month Day</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getByYearDay <em>By Year Day</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getByWeekNo <em>By Week No</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getByMonth <em>By Month</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getWkst <em>Wkst</em>}</li>
 *   <li>{@link SrcSwitchedTimeImpl#getBySetPos <em>By Set Pos</em>}</li>
 * </ul>
 *
 * @generated
 */
