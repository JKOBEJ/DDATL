...
public class JointPackage_CPL2SPLPackageImpl extends EPackageImpl implements JointPackage_CPL2SPLPackage {
	 ...
	 * <!-- end-user-doc -->
	 * @see Registry
	 * @see JointPackage_CPL2SPLPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static JointPackage_CPL2SPLPackage init() {
		if (isInited) return (JointPackage_CPL2SPLPackage) Registry.INSTANCE.getEPackage(JointPackage_CPL2SPLPackage.eNS_URI);

		// Obtain or create and register package
		JointPackage_CPL2SPLPackageImpl theJointPackage_CPL2SPLPackage = (JointPackage_CPL2SPLPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof JointPackage_CPL2SPLPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new JointPackage_CPL2SPLPackageImpl());
		...
		Registry.INSTANCE.put(JointPackage_CPL2SPLPackage.eNS_URI, theJointPackage_CPL2SPLPackage);
