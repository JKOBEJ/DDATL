 ...
 * </p>
 * <ul>
 *   <li>{@link TrgIfStat#getCondition <em>Condition</em>}</li>
 *   <li>{@link TrgIfStat#getThenStatements <em>Then Statements</em>}</li>
 *   <li>{@link TrgIfStat#getElseStatements <em>Else Statements</em>}</li>
 * </ul>
 *
 * @see JointPackage_CPL2SPLPackage#getTrgIfStat()
 * @model
 * @generated
 */
public interface TrgIfStat extends TrgStatement {
	 ...
	 * @see JointPackage_CPL2SPLPackage#getTrgIfStat_Condition()
	...
	/**
	 * Sets the value of the '{@link TrgIfStat#getCondition <em>Condition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see JointPackage_CPL2SPLPackage#getTrgIfStat_ThenStatements()
	 ...
	 * @see JointPackage_CPL2SPLPackage#getTrgIfStat_ElseStatements()
