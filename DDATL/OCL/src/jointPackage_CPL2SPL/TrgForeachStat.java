 ...
 * </p>
 * <ul>
 *   <li>{@link TrgForeachStat#getIteratorName <em>Iterator Name</em>}</li>
 *   <li>{@link TrgForeachStat#getSequenceExp <em>Sequence Exp</em>}</li>
 *   <li>{@link TrgForeachStat#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @see JointPackage_CPL2SPLPackage#getTrgForeachStat()
 * @model
 * @generated
 */
public interface TrgForeachStat extends TrgStatement {
	 ...
	 * @see JointPackage_CPL2SPLPackage#getTrgForeachStat_IteratorName()
	...
	/**
	 * Sets the value of the '{@link TrgForeachStat#getIteratorName <em>Iterator Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see JointPackage_CPL2SPLPackage#getTrgForeachStat_SequenceExp()
	...
	/**
	 * Sets the value of the '{@link TrgForeachStat#getSequenceExp <em>Sequence Exp</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see JointPackage_CPL2SPLPackage#getTrgForeachStat_Statements()
