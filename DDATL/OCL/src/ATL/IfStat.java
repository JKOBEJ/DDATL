 ...
 * <ul>
 *   <li>{@link IfStat#getCondition <em>Condition</em>}</li>
 *   <li>{@link IfStat#getThenStatements <em>Then Statements</em>}</li>
 *   <li>{@link IfStat#getElseStatements <em>Else Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @see ATLPackage#getIfStat()
 * @model
 * @generated
 */
public interface IfStat extends Statement {
	 ...
	 * @see ATLPackage#getIfStat_Condition()
	...
	/**
	 * Sets the value of the '{@link IfStat#getCondition <em>Condition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ATLPackage#getIfStat_ThenStatements()
	 ...
	 * @see ATLPackage#getIfStat_ElseStatements()
	 * @model type="ATL.Statement" containment="true"
	 * @generated
	 */
