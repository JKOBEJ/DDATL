 ...
 * <ul>
 *   <li>{@link OutPatternElementImpl#getOutPattern <em>Out Pattern</em>}</li>
 *   <li>{@link OutPatternElementImpl#getSourceElement <em>Source Element</em>}</li>
 *   <li>{@link OutPatternElementImpl#getBindings <em>Bindings</em>}</li>
 *   <li>{@link OutPatternElementImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class OutPatternElementImpl extends PatternElementImpl implements OutPatternElement {
	...
	public EList getBindings() {
		if (bindings == null) {
			bindings = new EObjectContainmentWithInverseEList(Binding.class, this, ATLPackage.OUT_PATTERN_ELEMENT__BINDINGS, ATLPackage.BINDING__OUT_PATTERN_ELEMENT);
		}
		return bindings;
	}
