 ...
 * <ul>
 *   <li>{@link RuleImpl#getOutPattern <em>Out Pattern</em>}</li>
 *   <li>{@link RuleImpl#getActionBlock <em>Action Block</em>}</li>
 *   <li>{@link RuleImpl#getVariables <em>Variables</em>}</li>
 *   <li>{@link RuleImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RuleImpl extends ModuleElementImpl implements Rule {
	...
	public EList getVariables() {
		if (variables == null) {
			variables = new EObjectContainmentWithInverseEList(RuleVariableDeclaration.class, this, ATLPackage.RULE__VARIABLES, ATLPackage.RULE_VARIABLE_DECLARATION__RULE);
		}
		return variables;
	}
