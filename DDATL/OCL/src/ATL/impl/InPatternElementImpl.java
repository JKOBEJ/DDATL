 ...
 * <ul>
 *   <li>{@link InPatternElementImpl#getMapsTo <em>Maps To</em>}</li>
 *   <li>{@link InPatternElementImpl#getInPattern <em>In Pattern</em>}</li>
 *   <li>{@link InPatternElementImpl#getModels <em>Models</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class InPatternElementImpl extends PatternElementImpl implements InPatternElement {
	...
	public EList getModels() {
		if (models == null) {
			models = new EObjectResolvingEList(OclModel.class, this, ATLPackage.IN_PATTERN_ELEMENT__MODELS);
		}
		return models;
	}
