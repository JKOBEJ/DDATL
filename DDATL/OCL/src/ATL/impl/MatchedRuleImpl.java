 ...
 * <ul>
 *   <li>{@link MatchedRuleImpl#getInPattern <em>In Pattern</em>}</li>
 *   <li>{@link MatchedRuleImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link MatchedRuleImpl#getSuperRule <em>Super Rule</em>}</li>
 *   <li>{@link MatchedRuleImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link MatchedRuleImpl#isIsRefining <em>Is Refining</em>}</li>
 *   <li>{@link MatchedRuleImpl#isIsNoDefault <em>Is No Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
