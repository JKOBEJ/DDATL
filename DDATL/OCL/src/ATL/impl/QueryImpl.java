 ...
 * <ul>
 *   <li>{@link QueryImpl#getBody <em>Body</em>}</li>
 *   <li>{@link QueryImpl#getHelpers <em>Helpers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QueryImpl extends UnitImpl implements Query {
	...
	public EList getHelpers() {
		if (helpers == null) {
			helpers = new EObjectContainmentWithInverseEList(Helper.class, this, ATLPackage.QUERY__HELPERS, ATLPackage.HELPER__QUERY);
		}
		return helpers;
	}
