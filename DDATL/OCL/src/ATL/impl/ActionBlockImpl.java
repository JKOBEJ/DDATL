 ...
 * <ul>
 *   <li>{@link ActionBlockImpl#getRule <em>Rule</em>}</li>
 *   <li>{@link ActionBlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionBlockImpl extends LocatedElementImpl implements ActionBlock {
	...
	public EList getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList(Statement.class, this, ATLPackage.ACTION_BLOCK__STATEMENTS);
		}
		return statements;
	}
