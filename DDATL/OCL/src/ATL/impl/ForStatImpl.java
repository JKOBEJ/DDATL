 ...
 * <ul>
 *   <li>{@link ForStatImpl#getIterator <em>Iterator</em>}</li>
 *   <li>{@link ForStatImpl#getCollection <em>Collection</em>}</li>
 *   <li>{@link ForStatImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForStatImpl extends StatementImpl implements ForStat {
	...
	public EList getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList(Statement.class, this, ATLPackage.FOR_STAT__STATEMENTS);
		}
		return statements;
	}
