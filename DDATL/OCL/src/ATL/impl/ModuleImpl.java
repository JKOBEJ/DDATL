 ...
 * <ul>
 *   <li>{@link ModuleImpl#isIsRefining <em>Is Refining</em>}</li>
 *   <li>{@link ModuleImpl#getInModels <em>In Models</em>}</li>
 *   <li>{@link ModuleImpl#getOutModels <em>Out Models</em>}</li>
 *   <li>{@link ModuleImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
