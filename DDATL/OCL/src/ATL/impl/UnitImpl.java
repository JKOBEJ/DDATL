 ...
 * <ul>
 *   <li>{@link UnitImpl#getLibraries <em>Libraries</em>}</li>
 *   <li>{@link UnitImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitImpl extends LocatedElementImpl implements Unit {
	...
	public EList getLibraries() {
		if (libraries == null) {
			libraries = new EObjectContainmentWithInverseEList(LibraryRef.class, this, ATLPackage.UNIT__LIBRARIES, ATLPackage.LIBRARY_REF__UNIT);
		}
		return libraries;
	}
