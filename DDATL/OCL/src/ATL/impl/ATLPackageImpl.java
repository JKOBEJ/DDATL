...
public class ATLPackageImpl extends EPackageImpl implements ATLPackage {
	...
	public static ATLPackage init() {
		if (isInited) return (ATLPackage) Registry.INSTANCE.getEPackage(ATLPackage.eNS_URI);

		// Obtain or create and register package
		ATLPackageImpl theATLPackage = (ATLPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof ATLPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new ATLPackageImpl());

		isInited = true;

		// Obtain or create and register interdependencies
		OCLPackageImpl theOCLPackage = (OCLPackageImpl)(Registry.INSTANCE.getEPackage(OCLPackage.eNS_URI) instanceof OCLPackageImpl ? Registry.INSTANCE.getEPackage(OCLPackage.eNS_URI) : OCLPackage.eINSTANCE);
		...
		Registry.INSTANCE.put(ATLPackage.eNS_URI, theATLPackage);
	...
	public void initializePackageContents() {
		...
		OCLPackage theOCLPackage = (OCLPackage) Registry.INSTANCE.getEPackage(OCLPackage.eNS_URI);
